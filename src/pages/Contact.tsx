...
const ContactUs = () => {
    ...
    try {
      const response = await fetch('https://api.web3forms.com/submit', {
        ...
        body: JSON.stringify({
          ...
          from_name: 'Nhlanhlayethu Website Contact Form',
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: "Visit Us",
      details: "77 Somlandela Dr, Newtown B Ext, Inanda, 4310",
      url: "https://maps.app.goo.gl/aX1T4piYg3duN5BC6",
            ...
            <div className="sticky top-6 space-y-8">
              <div className="bg-white p-6 rounded-xl shadow-lg">
                ...
                <div className="relative h-80 rounded-lg overflow-hidden border-2 border-gray-200">
                  <iframe 
                  title="Nhlanhlayethu Secondary School Location"
                ...
                <p className="text-xs text-gray-500 mt-3 text-center">77 Somlandela Dr, Newtown B Ext, Inanda, 4310</p>
              </div>
